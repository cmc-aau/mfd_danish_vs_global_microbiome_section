...
grid <- data.table::fread('output/2024-03-07_samples-grid-10km.csv')
...
data.table::fwrite(files, "output/2024-04-07_libs-classification.txt", col.names = FALSE)
...
data.table::fwrite(patterns, "output/2024-04-07_forward-reads-classification.txt", col.names = FALSE)
