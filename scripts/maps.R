...
## Subset ampvis object based on lacking information and geographical location
ampvis.sub <- mfd.ampvis.arcbac.ra %>%
  amp_subset_samples(!is.na(mfd_hab1),
                     !is.na(longitude),
                     latitude <= 58.5 & latitude >= 54,
                     longitude <= 19 & longitude >= 8)

## Extract metadata from ampvis object and create "complex" correponding to full MFDO1 string
